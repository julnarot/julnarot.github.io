          ...
          <div className="relative transform overflow-hidden  bg-gray-400 dark:bg-zinc-800 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-4xl  shadow-[16px_23px_0px_-9px_rgba(0,_0,_0,_1)]">
            <div className="flex-1  p-1 pt-2 text-white flex flex-col md:flex-row w-full h-full overflow-auto">
              <div className="border-4 border-double border-white p-2  relative h-full w-full ">
                <div
                  className="absolute -top-3 left-3 bg-gray-400 dark:bg-zinc-800 px-1 text-sm cursor-pointer"
                  onClick={onClose}
                >
                  {" "}
                  [<span className="text-green-400">&#9632;</span>]
                </div>
                <div className="absolute -top-3 left-1/2 bg-gray-400 dark:bg-zinc-800 transform -translate-x-1/2  px-2 text-sm">
                  {experience.proyect}
                </div>
                ...
                <div className="px-1 pt-2 text-stone-950 selection:bg-cyan-400 flex flex-col ">
                  <div className=" flex  flex-wrap max-md:flex-col">
                    <Input
                      label={t("workExperience.project.labelCustomer")}
                      value={experience.departmentName}
                    />

                    <Input
                      label={t("workExperience.project.labelTypeEmployment")}
                      value={experience.typeEmployment}
                    />

                    <Input
                      label={t(
                        "workExperience.project.labelEmploymentModality"
                      )}
                      value={experience.modality}
                    />

                    <Input
                      label={t("workExperience.project.labelDuration")}
                      value={
                        experience.startDateStr +
                        " - " +
                        experience.endDateStr +
                        " (" +
                        experience.duration +
                        ")"
                      }
                  ...
                  <div className="mb-1 flex flex-col md:flex-row mb-2">
                    <span className=" mr-2 dark:text-white">
                      <span className="text-yellow-400 dark:text-cyan-300">
                        S
                      </span>
                      kills:
                    </span>
                    <ul
                      className="bg-blue-600 dark:bg-purple-900 pl-2 text-white bold-text whitespace-nowrap  overflow overflow-y-hidden
                    ...
                    >
                      <li className="inline-block py-1">
                        ...
                        <label
                          htmlFor="opc-all"
                          className="before:content-['(_)'] peer-checked:before:content-['(x)']  cursor-pointer  mr-2"
                        >
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-8 gap-4 mb-2">
                    <div class="col-span-6">
                      <Label
                        ...
                        firstCharHighLighting={true}
                      />

                      <ShowWindow>
                        <ul className="list-disc list-outside px-3 text-sm text-white ">
                          {[...experience.activities]
                            .filter((f) =>
                              skill ? f.skills.includes(skill) : true
                            )
                            .map((activity, index) => (
                    ...
                    <div class="col-span-2">
                      ...
                      />
                      <div
                        className="bg-cyan-500 dark:bg-zinc-900 h-[90%] overflow-y-auto p-2
                      [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-track]:bg-bluen-600 [&::-webkit-scrollbar-thumb]:bg-gray-200"
                      >
                        <ul className="list-none list-outside  text-sm">
                  ...
                  <div className="flex justify-center p-2">
                    <Button
                      value={t("workExperience.project.btnCloseName")}
                      onClick={onClose}
                    />
                  </div>
                </div>
